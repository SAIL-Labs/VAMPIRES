...
class geometric_star():
    def __init__(self, model_params):
        ...
        self.H_610 = model_params['H_scat_610']
        self.V_610 = model_params['V_scat_610']
        self.H45_610 = model_params['H45_scat_610']
        self.V45_610 = model_params['V45_scat_610']
        self.dftm_grid_610 = model_params['dftm_grid_610']

        self.H_670 = model_params['H_scat_670']
        self.V_670 = model_params['V_scat_670']
        self.H45_670 = model_params['H45_scat_670']
        self.V45_670 = model_params['V45_scat_670']
        self.dftm_grid_670 = model_params['dftm_grid_670']


        self.H_720 = model_params['H_scat_720']
        self.V_720 = model_params['V_scat_720']
        self.H45_720 = model_params['H45_scat_720']
        self.V45_720 = model_params['V45_scat_720']
        self.dftm_grid_720 = model_params['dftm_grid_720']


        self.H_760 = model_params['H_scat_760']
        self.V_760 = model_params['V_scat_760']
        self.H45_760 = model_params['H45_scat_760']
        self.V45_760 = model_params['V45_scat_760']
        self.dftm_grid_760 = model_params['dftm_grid_760']

        self.xdata_760 = model_params['xdata_760']
        self.zdata_760 = model_params['zdata_760']

        self.xdata_720 = model_params['xdata_720']
        self.zdata_720 = model_params['zdata_720']

        self.xdata_670 = model_params['xdata_670']
        self.zdata_670 = model_params['zdata_670']

        self.xdata_610 = model_params['xdata_610']
        self.zdata_610 = model_params['zdata_610']
    ...
    def make_3D_model(self):
        ...
        self.rad_profile = self.model_params['dust_pl_const'] * (rad_profile ** (-self.model_params['dust_pl_exp']))
        # self.rad_profile = self.rad_profile/self.rad_profile.max()
        ...
        if self.model_params['dust_shape'] == 'bright_spot_ellipse':
            ...
            def mask_cone(theta, phi, theta_bright, phi_bright, phi_width, mag):
                """Create a single conical bright region centered at (theta_bright, phi_bright) with width phi_width."""

                # Convert spherical coordinates to unit vectors
                v_x = np.cos(theta) * np.sin(phi)
                v_y = np.sin(theta) * np.sin(phi)
                v_z = np.cos(phi)

                # Bright spot unit vector
                v_bright_x = np.cos(theta_bright) * np.sin(phi_bright)
                v_bright_y = np.sin(theta_bright) * np.sin(phi_bright)
                v_bright_z = np.cos(phi_bright)

                # Compute angular distance via dot product
                cos_d = v_x * v_bright_x + v_y * v_bright_y + v_z * v_bright_z
                cos_d = np.clip(cos_d, -1.0, 1.0)  # Avoid numerical errors

                # Convert back to angle
                d = np.arccos(cos_d)

                # Mask region inside the cone
                mask = d <= phi_width

                return np.where(mask, mag, 1.0)

            # Define bright spot parameters
        ...
        sum_760_H = self.H_760.sum()
        sum_760_V = self.V_760.sum()
        sum_760_H45 = self.H45_760.sum()
        sum_760_V45 = self.V45_760.sum()

        ############################

        self.H_610 = self.H_610/sum_760_H
        self.V_610 = self.V_610/sum_760_V
        self.H45_610 = self.H45_610/sum_760_H45
        self.V45_610 = self.V45_610/sum_760_V45

        self.H_670 = self.H_670/sum_760_H
        self.V_670  = self.V_670/sum_760_V
        self.H45_670 = self.H45_670/sum_760_H45
        self.V45_670 = self.V45_670/sum_760_V45

        self.H_720 = self.H_720/sum_760_H
        self.V_720 = self.V_720/sum_760_V
        self.H45_720 = self.H45_720/sum_760_H45
        self.V45_720 = self.V45_720/sum_760_V45

        self.H_760 = self.H_760/sum_760_H
        self.V_760 = self.V_760/sum_760_V
        self.H45_760 = self.H45_760/sum_760_H45
        self.V45_760 = self.V45_760/sum_760_V45 # this had a double slash - the probem?

        #####################################################################################

        self.H_diff_610 =   self.shell * self.H_610
        self.V_diff_610 =   self.shell * self.V_610
        self.H45_diff_610 = self.shell * self.H45_610
        self.V45_diff_610 = self.shell * self.V45_610

        self.H_diff_670 =   self.shell * self.H_670
        self.V_diff_670 =   self.shell * self.V_670
        self.H45_diff_670 = self.shell * self.H45_670
        self.V45_diff_670 = self.shell * self.V45_670

        self.H_diff_720 =   self.shell * self.H_720
        self.V_diff_720 =   self.shell * self.V_720
        self.H45_diff_720 = self.shell * self.H45_720
        self.V45_diff_720 = self.shell * self.V45_720



        self.H_diff_760 =   self.shell * self.H_760
        self.V_diff_760 =   self.shell * self.V_760
        self.H45_diff_760 = self.shell * self.H45_760
        self.V45_diff_760 = self.shell * self.V45_760

        ######################################################################

        self.H_diff_610 = self.H_diff_610.sum(axis=2)
        self.V_diff_610 = self.V_diff_610.sum(axis=2)
        self.H45_diff_610 = self.H45_diff_610.sum(axis=2)
        self.V45_diff_610 = self.V45_diff_610.sum(axis=2)

        self.H_diff_670 = self.H_diff_670.sum(axis=2)
        self.V_diff_670 = self.V_diff_670.sum(axis=2)
        self.H45_diff_670 = self.H45_diff_670.sum(axis=2)
        self.V45_diff_670 = self.V45_diff_670.sum(axis=2)

        self.H_diff_720 = self.H_diff_720.sum(axis=2)
        self.V_diff_720 = self.V_diff_720.sum(axis=2)
        self.H45_diff_720 = self.H45_diff_720.sum(axis=2)
        self.V45_diff_720 = self.V45_diff_720.sum(axis=2)

        self.H_diff_760 = self.H_diff_760.sum(axis=2)
        self.V_diff_760 = self.V_diff_760.sum(axis=2)
        self.H45_diff_760 = self.H45_diff_760.sum(axis=2)
        self.V45_diff_760 = self.V45_diff_760.sum(axis=2)

        ########################################################################################################################

        total_flux = np.sum(self.H_diff_760 + self.V_diff_760)
        self.star = (star / star.sum()) * total_flux * self.dust_star_contrast


        ########################################################################################################################

        self.H_diff_610 =   self.H_diff_610   + self.star
        self.V_diff_610 =   self.V_diff_610   + self.star
        self.H45_diff_610 = self.H45_diff_610 + self.star
        self.V45_diff_610 = self.V45_diff_610 + self.star  # physically accurate images

        self.H_diff_670 =   self.H_diff_670   + self.star
        self.V_diff_670 =   self.V_diff_670   + self.star
        self.H45_diff_670 = self.H45_diff_670 + self.star
        self.V45_diff_670 = self.V45_diff_670 + self.star  # physically accurate images


        self.H_diff_720 =   self.H_diff_720   + self.star
        self.V_diff_720 =   self.V_diff_720   + self.star
        self.H45_diff_720 = self.H45_diff_720 + self.star
        self.V45_diff_720 = self.V45_diff_720 + self.star  # physically accurate images


        self.H_diff_760 =   self.H_diff_760   + self.star
        self.V_diff_760 =   self.V_diff_760   + self.star
        self.H45_diff_760 = self.H45_diff_760 + self.star
        self.V45_diff_760 = self.V45_diff_760 + self.star  # physically accurate images

        ########################################################################################################################

        self.image_I_610 = self.H_diff_610 + self.V_diff_610
        self.image_Q_610 = self.H_diff_610 - self.V_diff_610
        self.image_U_610 = self.H45_diff_610 - self.V45_diff_610


        self.image_I_670 = self.H_diff_670 + self.V_diff_670
        self.image_Q_670 = self.H_diff_670 - self.V_diff_670
        self.image_U_670 = self.H45_diff_670 - self.V45_diff_670


        self.image_I_720 = self.H_diff_720 + self.V_diff_720
        self.image_Q_720 = self.H_diff_720 - self.V_diff_720
        self.image_U_720 = self.H45_diff_720 - self.V45_diff_720 # broke



        self.image_I_760 = self.H_diff_760 + self.V_diff_760
        self.image_Q_760 = self.H_diff_760 - self.V_diff_760
        self.image_U_760 = self.H45_diff_760 - self.V45_diff_760
    ...
    def make_pol_diff_vis(self):
        ...
        ft_Hdiff_610 = self.apply_DFTM1(self.H_diff_610, self.dftm_grid_610)
        ft_Vdiff_610 = self.apply_DFTM1(self.V_diff_610, self.dftm_grid_610)
        ft_H45diff_610 = self.apply_DFTM1(self.H45_diff_610, self.dftm_grid_610)
        ft_V45diff_610 = self.apply_DFTM1(self.V45_diff_610, self.dftm_grid_610)

        self.hwp0_vis_610 = self.calc_vis(ft_Hdiff_610)
        self.hwp225_vis_610 =  self.calc_vis(ft_H45diff_610)
        self.hwp45_vis_610 =  self.calc_vis(ft_Vdiff_610)
        self.hwp675_vis_610  =  self.calc_vis(ft_V45diff_610)

        self.hwp0_cp_610 = self.calc_cp(ft_Hdiff_610, self.indx_of_cp)
        self.hwp225_cp_610 = self.calc_cp(ft_H45diff_610, self.indx_of_cp)
        self.hwp45_cp_610 = self.calc_cp(ft_Vdiff_610, self.indx_of_cp)
        self.hwp675_cp_610 = self.calc_cp(ft_V45diff_610, self.indx_of_cp)

        self.diff_Q_610 =  self.hwp0_vis_610/self.hwp45_vis_610
        self.diff_U_610 = self.hwp225_vis_610/self.hwp675_vis_610
        self.Q_cp_610 = self.hwp0_cp_610 - self.hwp45_cp_610
        self.U_cp_610 = self.hwp225_cp_610 - self.hwp675_cp_610

        ############################################################

        ft_Hdiff_670 = self.apply_DFTM1(self.H_diff_670, self.dftm_grid_670)
        ft_Vdiff_670 = self.apply_DFTM1(self.V_diff_670, self.dftm_grid_670)
        ft_H45diff_670 = self.apply_DFTM1(self.H45_diff_670, self.dftm_grid_670)
        ft_V45diff_670 = self.apply_DFTM1(self.V45_diff_670, self.dftm_grid_670)

        self.hwp0_vis_670 = self.calc_vis(ft_Hdiff_670)
        self.hwp225_vis_670 = self.calc_vis(ft_H45diff_670)
        self.hwp45_vis_670 = self.calc_vis(ft_Vdiff_670)
        self.hwp675_vis_670 = self.calc_vis(ft_V45diff_670)

        self.hwp0_cp_670 = self.calc_cp(ft_Hdiff_670, self.indx_of_cp)
        self.hwp225_cp_670 = self.calc_cp(ft_H45diff_670, self.indx_of_cp)
        self.hwp45_cp_670 = self.calc_cp(ft_Vdiff_670, self.indx_of_cp)
        self.hwp675_cp_670 = self.calc_cp(ft_V45diff_670, self.indx_of_cp)

        self.diff_Q_670 = self.hwp0_vis_670 / self.hwp45_vis_670
        self.diff_U_670 = self.hwp225_vis_670 / self.hwp675_vis_670
        self.Q_cp_670 = self.hwp0_cp_670 - self.hwp45_cp_670
        self.U_cp_670 = self.hwp225_cp_670 - self.hwp675_cp_670

        ############################################################

        ft_Hdiff_720 = self.apply_DFTM1(self.H_diff_720, self.dftm_grid_720)
        ft_Vdiff_720 = self.apply_DFTM1(self.V_diff_720, self.dftm_grid_720)
        ft_H45diff_720 = self.apply_DFTM1(self.H45_diff_720, self.dftm_grid_720)
        ft_V45diff_720 = self.apply_DFTM1(self.V45_diff_720, self.dftm_grid_720)

        self.hwp0_vis_720 = self.calc_vis(ft_Hdiff_720)
        self.hwp225_vis_720 = self.calc_vis(ft_H45diff_720)
        self.hwp45_vis_720 = self.calc_vis(ft_Vdiff_720)
        self.hwp675_vis_720 = self.calc_vis(ft_V45diff_720)

        self.hwp0_cp_720 = self.calc_cp(ft_Hdiff_720, self.indx_of_cp)
        self.hwp225_cp_720 = self.calc_cp(ft_H45diff_720, self.indx_of_cp)
        self.hwp45_cp_720 = self.calc_cp(ft_Vdiff_720, self.indx_of_cp)
        self.hwp675_cp_720 = self.calc_cp(ft_V45diff_720, self.indx_of_cp)

        self.diff_Q_720 = self.hwp0_vis_720 / self.hwp45_vis_720
        self.diff_U_720 = self.hwp225_vis_720 / self.hwp675_vis_720
        self.Q_cp_720 = self.hwp0_cp_720 - self.hwp45_cp_720
        self.U_cp_720 = self.hwp225_cp_720 - self.hwp675_cp_720

        ############################################################

        ft_Hdiff_760 = self.apply_DFTM1(self.H_diff_760, self.dftm_grid_760)
        ft_Vdiff_760 = self.apply_DFTM1(self.V_diff_760, self.dftm_grid_760)
        ft_H45diff_760 = self.apply_DFTM1(self.H45_diff_760, self.dftm_grid_760)
        ft_V45diff_760 = self.apply_DFTM1(self.V45_diff_760, self.dftm_grid_760)

        self.hwp0_vis_760 = self.calc_vis(ft_Hdiff_760)
        self.hwp225_vis_760 = self.calc_vis(ft_H45diff_760)
        self.hwp45_vis_760 = self.calc_vis(ft_Vdiff_760)
        self.hwp675_vis_760 = self.calc_vis(ft_V45diff_760)

        self.hwp0_cp_760 = self.calc_cp(ft_Hdiff_760, self.indx_of_cp)
        self.hwp225_cp_760 = self.calc_cp(ft_H45diff_760, self.indx_of_cp)
        self.hwp45_cp_760 = self.calc_cp(ft_Vdiff_760, self.indx_of_cp)
        self.hwp675_cp_760 = self.calc_cp(ft_V45diff_760, self.indx_of_cp)

        self.diff_Q_760 = self.hwp0_vis_760 / self.hwp45_vis_760
        self.diff_U_760 = self.hwp225_vis_760 / self.hwp675_vis_760
        self.Q_cp_760 = self.hwp0_cp_760 - self.hwp45_cp_760
        self.U_cp_760 = self.hwp225_cp_760 - self.hwp675_cp_760



        self.y_model = np.concatenate((self.diff_Q_610, self.diff_U_610, self.Q_cp_610, self.U_cp_610,
                                       self.diff_Q_670, self.diff_U_670, self.Q_cp_670, self.U_cp_670,
                                       self.diff_Q_720, self.diff_U_720, self.Q_cp_720, self.U_cp_720,
                                       self.diff_Q_760, self.diff_U_760, self.Q_cp_760, self.U_cp_760))
